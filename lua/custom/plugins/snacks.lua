return {
  {
    ...
    keys = {
      ...
      { "<leader>gr", function() Snacks.picker.git_grep() end, desc = "Git Grep" },
      { "<leader>gg", function() Snacks.lazygit() end, desc = "Lazygit" },
      { "<leader>go", function() Snacks.gitbrowse() end, desc = "Browse Repository", mode = { "n", "v" } },
      -- Search & Grep
      ...
      { "gI", function() Snacks.picker.lsp_implementations() end, desc = "Goto Implementation(s)" },
